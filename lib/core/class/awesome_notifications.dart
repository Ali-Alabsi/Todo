...
class NotificationController {
  ...
  static Future<void> onActionReceivedImplementationMethod(
      ReceivedAction receivedAction) async {
    MyAppNot.navigatorKey.currentState?.pushNamedAndRemoveUntil(
        '/notification-page',
            (route) =>
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = MyAppNot.navigatorKey.currentContext!;
    await showDialog(
        context: context,
...
///  *********************************************
///
class MyAppNot extends StatefulWidget {
  const MyAppNot({super.key});
  ...
  @override
  State<MyAppNot> createState() => _AppState();
}

class _AppState extends State<MyAppNot> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      navigatorKey: MyAppNot.navigatorKey,
